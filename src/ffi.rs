//! FFI surface for the iOS and Android clients.
//!
//! Built as a `staticlib` for iOS and a `cdylib` for Android. Bindings are
//! generated by `uniffi-bindgen`; the scaffolding lives at the crate root
//! (`src/lib.rs`) and this module holds the exported functions.
//!
